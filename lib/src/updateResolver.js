...
var graphQLMutationType_1 = require("./graphQLMutationType");
...
function getMongoDbUpdateResolver(graphQLType, updateCallback, updateOptions) {
    var _this = this;
    if (updateOptions === void 0) { updateOptions = defaultOptions; }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    mongoUpdate = mongoDbUpdate_1.default(args.update);
                    if (!updateOptions.differentOutputType)
...
function getGraphQLUpdateArgs(graphQLType) {
    return {
        ...
        update: { type: new graphql_1.GraphQLNonNull(graphQLMutationType_1.getGraphQLUpdateType(graphQLType)) }
    };
}
